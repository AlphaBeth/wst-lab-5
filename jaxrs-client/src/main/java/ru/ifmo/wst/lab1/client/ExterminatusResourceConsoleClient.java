...
public class ExterminatusResourceConsoleClient {
    ...
    public ExterminatusResourceConsoleClient(String baseUrl) {
        ...
        Command<Filter> filterCommand = new Command<>("filter",
                ...
                asList(
                        ...
                        new CommandArg<>(toNull(DATE_COMMAND_ARG), Filter::setDate)
                ),
                Filter::new, this::filter);
        Command<ExterminatusInfo> createCommand = new Command<>("create",
                "Create new exterminatus entity",
                asList(
                        new CommandArg<>(toNull(INITATOR_COMMAND_ARG), ExterminatusInfo::setInitiator),
                        new CommandArg<>(toNull(REASON_COMMAND_ARG), ExterminatusInfo::setReason),
                        new CommandArg<>(toNull(METHOD_COMMAND_ARG), ExterminatusInfo::setMethod),
                        new CommandArg<>(toNull(PLANET_COMMAND_ARG), ExterminatusInfo::setPlanet),
                        new CommandArg<>(toNull(DATE_COMMAND_ARG), ExterminatusInfo::setDate)
                ), ExterminatusInfo::new, this::create);
        Command<ExterminatusEntity> updateCommand = new Command<>("update",
                "Update exterminatus by id",
                asList(
                        new CommandArg<>(ID_COMMAND_ARG, ExterminatusEntity::setId),
                        new CommandArg<>(toNull(INITATOR_COMMAND_ARG), ExterminatusEntity::setInitiator),
                        new CommandArg<>(toNull(REASON_COMMAND_ARG), ExterminatusEntity::setReason),
                        new CommandArg<>(toNull(METHOD_COMMAND_ARG), ExterminatusEntity::setMethod),
                        new CommandArg<>(toNull(PLANET_COMMAND_ARG), ExterminatusEntity::setPlanet),
                        new CommandArg<>(toNull(DATE_COMMAND_ARG), ExterminatusEntity::setDate)
                ), ExterminatusEntity::new, this::update
        );
    ...
    public void create(ExterminatusInfo createArg) {
        long createdId = service.create(createArg);
        System.out.printf("Entity with id %d was created\n", createdId);
    }

    public void update(ExterminatusEntity updateArg) {
        int updateCount = service.update(updateArg);
